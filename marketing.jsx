...
function Footer() {
  const c = C();
  const isMobile = useWindowWidth() < 768;
  const colStyle = { font: '700 11px/1 "Inter", sans-serif', letterSpacing: "1.5px", textTransform: "uppercase", color: "#262626", marginBottom: 16 };
  const linkStyle = { display: "inline-flex", alignItems: "center", gap: 8, background: "#fff", border: "1px solid #e6e6e6", padding: "10px 16px", textDecoration: "none", font: '700 12px/1 "Inter", sans-serif', color: "#262626", letterSpacing: "0.5px" };
  return (
    <footer style={{ background: "#f6f7f9", padding: isMobile ? "48px 24px" : "64px 80px" }}>
      <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "2fr 1fr 1fr", gap: isMobile ? 40 : 48 }}>
        ...
        <div>
          ...
          <div style={{ marginTop: 24 }}>
            <a href="https://g.page/r/CWniJIMNhoVzEAI/review" target="_blank" rel="noopener noreferrer" style={linkStyle}>
        ...
        {/* Social + Documents */}
        <div>
          <div style={colStyle}>Follow Us</div>
          <a href="https://www.facebook.com/rentwithTVR/" target="_blank" rel="noopener noreferrer" style={{ ...linkStyle, marginBottom: 12 }}>
          ...
          <div style={{ marginTop: 28 }}>
            ...
            <a href="assets/TVR-Rental-Agreement.pdf" target="_blank" rel="noopener" style={linkStyle}>
