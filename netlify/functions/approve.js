...
function customerConfirmationEmail(booking, approvedAt, photoUrls) {
  ...
  const terms = [
    ...
    ["§4. Damage, Loss, Theft and Reporting", "You are responsible for all loss, theft, damage, destruction, or total loss of the trailer and any included equipment during the rental period, whether or not you are at fault. If insurance applies, you remain responsible for the insurance deductible, any uncovered damages, Loss of Use, Diminished Value, towing, recovery, storage, administrative costs, and any amount not paid by insurance. You acknowledge that you may be liable for up to the full replacement value of the trailer if insurance denies or does not fully cover the claim. You must report all accidents, theft, damage, or loss to us and police within 24 hours."],
    ["§5. Equipment / Replacement Cost", "You acknowledge the following replacement values: Enclosed Cargo Trailer (Spartan 7×14) — $7,000; Car Hauler / Equipment Trailer (Liberty 7×20) — $5,000. If the rented trailer or any included equipment is lost, stolen, damaged, or not returned, you agree to pay the listed replacement value or the cost of actual repair, whichever is greater. These values represent the minimum liability and do not limit recovery of additional documented losses."],
